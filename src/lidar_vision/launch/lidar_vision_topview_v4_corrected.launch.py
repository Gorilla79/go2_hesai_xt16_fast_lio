...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable="lidar_vision_topview_v4_node",
            name="lidar_vision_topview_v4_node",
            output="screen",
            parameters=[
                calibration_config,
                {
                    ...
                    "max_lidar_points_process": 20000,
                    "max_lidar_points_topview": 6000,
                    "skip_lidar_projection_if_points_over": 30000,
                    ...
                    # V3.5 Phase 1: 360-degree BEV safety layer
                    "enable_360_bev": True,
                    "enable_self_filter": True,
                    "self_filter_x_min": -0.65,
                    "self_filter_x_max": 0.85,
                    "self_filter_y_min": -0.55,
                    "self_filter_y_max": 0.55,
                    "self_filter_z_min": -0.60,
                    "self_filter_z_max": 1.20,
                    "enable_ground_filter": True,
                    "ground_filter_z_min": -0.05,
                    "safety_z_max": 1.80,
                    "safety_min_radius": 0.65,
                    "safety_max_radius": 12.00,
                    "sector_front_half_angle_deg": 45.0,
                    "sector_rear_half_angle_deg": 45.0,
                    "sector_min_points": 12,
                    "sector_distance_percentile": 15.0,
                    "sector_stop_distance": 0.80,
                    "sector_slow_distance": 1.80,
                    "sector_caution_distance": 3.50,
                    "draw_sector_boundaries": True,
                    "draw_self_filter_zone": True,

                    # XT16-specific stabilization
                    "enable_deterministic_downsampling": True,
                    "process_voxel_size": 0.06,
                    "topview_voxel_size": 0.10,
                    "cluster_voxel_size": 0.08,

                    # XT16 azimuth-bin sector risk
                    "sector_azimuth_bin_deg": 1.0,
                    "sector_bin_min_points": 2,
                    "sector_min_occupied_bins": 3,
                    "sector_distance_ema_alpha": 0.30,

                    # XT16 sparse long-range cluster thresholds
                    "cluster_near_distance": 4.0,
                    "cluster_far_distance": 8.0,
                    "cluster_near_min_points": 8,
                    "cluster_mid_min_points": 5,
                    "cluster_far_min_points": 3,

                    # V3.6: 360-degree LiDAR cluster temporal tracking
                    "enable_lidar_cluster_tracking": True,
                    "cluster_track_match_distance": 1.00,
                    "cluster_track_size_weight": 0.35,
                    "cluster_track_sector_gate": False,
                    "cluster_track_confirm_hits": 2,
                    "cluster_track_max_missed": 5,
                    "cluster_track_smoothing_alpha": 0.30,
                    "cluster_track_min_age_to_draw": 2,
                    "cluster_track_draw_tentative": False,

                    # V4: stationary-robot 360-degree motion estimation
                    "enable_motion_estimation": True,
                    "assume_robot_stationary": True,
                    "motion_use_hungarian": True,

                    # Constant-velocity Kalman filter
                    "motion_process_noise": 1.20,
                    "motion_measurement_noise": 0.12,
                    "motion_initial_velocity_variance": 4.00,
                    "motion_min_dt": 0.03,
                    "motion_max_dt": 0.30,

                    # Motion confirmation
                    "motion_history_size": 6,
                    "motion_min_track_hits": 3,
                    "motion_jitter_radius": 0.12,
                    "motion_min_displacement": 0.12,
                    "motion_min_speed": 0.12,
                    "motion_possible_speed": 0.06,
                    "motion_confirm_frames": 2,
                    "motion_release_frames": 3,
                    "motion_direction_consistency": 0.55,
                    "motion_allow_structure_like": False,

                    # Temporal BEV occupancy-change evidence
                    "motion_bev_resolution": 0.15,
                    "motion_bev_local_radius": 0.65,
                    "motion_bev_change_min_cells": 3,
                    "motion_bev_min_current_cells": 2,

                    # Visualization
                    "draw_motion_arrows": True,
                    "motion_arrow_prediction_sec": 1.0,
                    "motion_arrow_min_pixels": 12,

                    # V4 correction: foreground/background motion layer
                    "enable_motion_foreground_layer": True,
                    ...
                    "motion_foreground_max_clusters": 20,
                    "motion_foreground_near_ignore_radius": 0.80,
