    ...
    return LaunchDescription(
        [
            Node(
                ...
                executable="lidar_vision_topview_v4_3_optimized_node",
                name="lidar_vision_topview_v4_3_optimized_node",
                output="screen",
                parameters=[
                    {
                        # Topics
                        ...
                        "window_name": "LiDAR V4.3 Optimized Coordinate Validation",
                        "draw_sector_nearest_markers": False,
                        "enable_click_coordinate_probe": True,
                        "click_probe_radius_m": 0.25,
                        "click_probe_min_points": 8,
                        "info_panel_width": 430,
                        "show_sector_summary": False,
                        "show_raw_bev_inset": False,
                        "raw_ground_update_divider": 5,
                        "aligned_ground_update_divider": 2,
                        "render_stride": 1,
                        "enable_fast_numpy_parser": True,
                        "fast_voxel_mode": "hash",
                        "calculation_stride": 1,
                        "probe_source_max_points": 10000,
