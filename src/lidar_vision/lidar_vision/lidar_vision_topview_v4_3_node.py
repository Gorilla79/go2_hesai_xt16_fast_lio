...
class LiDARVisionTopViewV43Node(Node):
    """
    ...
    def __init__(self):
        super().__init__("lidar_vision_topview_v4_3_node")
        ...
        self.declare_parameter("window_name", "LiDAR V4.3 Coordinate Validation")
        ...
        self.get_logger().info(
            "V4.3 single-BEV coordinate validation node started."
        )
        self.get_logger().info(
...
def main(args=None):
    ...
    node = LiDARVisionTopViewV43Node()
