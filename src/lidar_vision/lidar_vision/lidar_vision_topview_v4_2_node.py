...
class LiDARVisionTopViewV42Node(Node):
    """
    V4.2 diagnostic node for gravity alignment and click-based coordinate verification.
    ...
    def __init__(self):
        super().__init__("lidar_vision_topview_v4_2_node")
        ...
        self.declare_parameter("window_name", "LiDAR V4.2 Coordinate Validation")
        ...
        self.get_logger().info(
            "V4.2 click-based coordinate validation node started."
        )
        self.get_logger().info(
...
def main(args=None):
    ...
    node = LiDARVisionTopViewV42Node()
