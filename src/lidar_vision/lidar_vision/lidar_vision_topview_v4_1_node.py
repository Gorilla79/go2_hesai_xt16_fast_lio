...
class LiDARVisionTopViewV41Node(Node):
    """
    ...
    def __init__(self):
        super().__init__("lidar_vision_topview_v4_1_node")
        ...
        self.declare_parameter("window_name", "LiDAR V4.1 Coordinate Validation")
        ...
        self.get_logger().info(
            "V4.1 coordinate validation node started."
        )
        self.get_logger().info(
...
def main(args=None):
    ...
    node = LiDARVisionTopViewV41Node()
